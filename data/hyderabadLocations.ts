...
export const hyderabadLocations: HydLocation[] = [
    ...
    { name: "Shamirpet Lake", lat: 17.5700, lon: 78.5600, category: "Tourist Place" },
    { name: "Genome Valley", lat: 17.5400, lon: 78.5100, category: "Tourist Place" },
    ...
    { name: "Paigah Tombs", lat: 17.3390, lon: 78.4590, category: "Tourist Place" },
